                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">
                      ...
                      with a focus on creating scalable and maintainable
                      solutions.
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">
                      Approaching challenges with analytical thinking and
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">
                      Staying at the forefront of technology trends and
